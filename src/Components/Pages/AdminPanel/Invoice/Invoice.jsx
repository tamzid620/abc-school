import "./Invoice.css";
import mLogo from "../../../../../public/icons/Gradient Logo Mark-01.png";
  ...
  return (
    <div>
      ...
      <div className="flex justify-center my-10">
        <ReactToPrint
          trigger={() => (
            <button className="btn bg-red-500 text-white border border-black shadow-lg shadow-black hover:text-black hover:border-black ">Print</button>
          )}
          content={() => ref.current}
        ></ReactToPrint>
      </div>
